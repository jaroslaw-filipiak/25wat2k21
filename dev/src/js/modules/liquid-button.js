export default class LiquidButton {
   constructor(svg) {
...
//  const buttons = document.getElementsByClassName('liquid-button__blog-item');
//  for (let buttonIndex = 0; buttonIndex < buttons.length; buttonIndex++) {
//    const button = buttons[buttonIndex];


//     console.log( button.getAttribute("data-width") );
    
//     button.setAttribute("margin", '10');
//     button.setAttribute("data-width", '100');
